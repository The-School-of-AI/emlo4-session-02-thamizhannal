...
def main():
    ...
    parser.add_argument('--resume', action='store_true', default=False,
                        help='For Training model from checkpoint')
    ...
    if args.resume:
        print("Resume model has been called!")
        model.load_state_dict(torch.load('model_checkpoint.pth'))
        model.eval()
        print("Training resume option was chosen and model loaded successfully!")
